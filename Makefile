...
ACLOCAL = ${SHELL} "/mnt/ssd/chaos/external/curl/missing" --run aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = /usr/bin/ar
AS = as
AUTOCONF = ${SHELL} "/mnt/ssd/chaos/external/curl/missing" --run autoconf
AUTOHEADER = ${SHELL} "/mnt/ssd/chaos/external/curl/missing" --run autoheader
AUTOMAKE = ${SHELL} "/mnt/ssd/chaos/external/curl/missing" --run automake-1.14
AWK = gawk
BLANK_AT_MAKETIME = 
CC = arm-eabi-gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -fno-exceptions -Wno-multichar -mthumb-interwork -mthumb -nostdlib -O2 -Wno-system-headers
CFLAG_CURL_SYMBOL_HIDING = -fvisibility=hidden
CONFIGURE_OPTIONS = " '--host=arm-linux' 'CC=arm-eabi-gcc' 'CPPFLAGS=-DANDROID -I/mnt/ssd/chaos/bionic/libc/arch-arm/include -I/mnt/ssd/chaos/bionic/libc/include -I/mnt/ssd/chaos/bionic/libc/kernel/common -I/mnt/ssd/chaos/bionic/libc/kernel/arch-arm -I/mnt/ssd/chaos/external/zlib ' 'CFLAGS=-fno-exceptions -Wno-multichar -mthumb-interwork -mthumb -nostdlib ' 'LIBS=-lc -ldl -lz /mnt/ssd/chaos/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/lib/gcc/arm-eabi/4.7/libgcc.a ' 'LDFLAGS=-L/mnt/ssd/chaos/out/target/product/mako/system/lib ' '--enable-ipv6' '--disable-manual' '--with-random=/dev/urandom' '--with-ssl=/mnt/ssd/chaos/external/openssl' '--without-ca-bundle' '--without-ca-path' '--with-zlib' 'host_alias=arm-linux'"
CPP = arm-eabi-gcc -E
CPPFLAGS = -DANDROID -isystem /mnt/ssd/chaos/bionic/libc/arch-arm/include -isystem /mnt/ssd/chaos/bionic/libc/include -isystem /mnt/ssd/chaos/bionic/libc/kernel/common -isystem /mnt/ssd/chaos/bionic/libc/kernel/arch-arm -isystem /mnt/ssd/chaos/external/zlib -I/mnt/ssd/chaos/external/openssl/include -I/mnt/ssd/chaos/external/openssl/include/openssl
...
CURL_NETWORK_AND_TIME_LIBS = -lc -ldl -lz /mnt/ssd/chaos/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/lib/gcc/arm-eabi/4.7/libgcc.a
CURL_NETWORK_LIBS = -lc -ldl -lz /mnt/ssd/chaos/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/lib/gcc/arm-eabi/4.7/libgcc.a
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
IPV6_ENABLED = 1
LD = /mnt/ssd/chaos/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/arm-eabi/bin/ld
LDFLAGS = -L/mnt/ssd/chaos/out/target/product/mako/system/lib -L/mnt/ssd/chaos/external/openssl/lib
LIBCURL_LIBS = -lssl -lcrypto -lz -lc -ldl -lz /mnt/ssd/chaos/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/lib/gcc/arm-eabi/4.7/libgcc.a
LIBMETALINK_CPPFLAGS = 
LIBMETALINK_LDFLAGS = 
LIBMETALINK_LIBS = 
LIBOBJS = 
LIBS = -lssl -lcrypto -lz -lc -ldl -lz /mnt/ssd/chaos/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/lib/gcc/arm-eabi/4.7/libgcc.a
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} "/mnt/ssd/chaos/external/curl/missing" --run makeinfo
MANIFEST_TOOL = :
MANOPT = -man
...
VERSIONNUM = 072200
ZLIB_LIBS = -lz
abs_builddir = /mnt/ssd/chaos/external/curl
abs_srcdir = /mnt/ssd/chaos/external/curl
abs_top_builddir = /mnt/ssd/chaos/external/curl
abs_top_srcdir = /mnt/ssd/chaos/external/curl
ac_ct_AR = 
ac_ct_CC = 
...
install_sh = ${SHELL} /mnt/ssd/chaos/external/curl/install-sh
